...
/**
 * Mirrors OpenClaw's `ResolvedAgentRoute` with additional intent fields.
 *
 * In the actual OpenClaw codebase this would extend the existing type; here
 * we define a compatible standalone version for self-contained development.
 */
export interface ResolvedAgentRoute {
  ...
  readonly lastRoutePolicy: 'main' | 'session'
